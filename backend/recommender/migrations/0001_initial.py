# Generated by Django 4.1.4 on 2023-01-09 11:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('careerSite', models.CharField(blank=True, max_length=120)),
                ('hiringManagerName', models.CharField(blank=True, max_length=120)),
                ('password', models.CharField(max_length=120)),
                ('title', models.CharField(blank=True, max_length=100)),
                ('resume', models.FileField(blank=True, upload_to='')),
                ('residence', models.CharField(blank=True, max_length=100)),
                ('DOB', models.DateField(blank=True, default=datetime.date(2023, 1, 9))),
                ('about', models.TextField(blank=True, max_length=1000)),
                ('timestamp', models.DateField(default=datetime.date(2023, 1, 9))),
        ...
        migrations.CreateModel(
            name='Skill',
            fields=[
                ('skillId', models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('certification', models.CharField(blank=True, max_length=1000)),
                ('timestamp', models.DateField(default=datetime.date(2023, 1, 9))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(default='no description', max_length=10000)),
                ('timestamp', models.DateField(default=datetime.date(2023, 1, 9))),
                ('userId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
